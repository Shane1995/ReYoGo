...
ALTER TABLE `inventory_items` ADD `entity_id` text NOT NULL REFERENCES entities(id);--> statement-breakpoint
ALTER TABLE `invoices` ADD `entity_id` text NOT NULL REFERENCES entities(id);--> statement-breakpoint
CREATE INDEX `invoices_entity_idx` ON `invoices` (`entity_id`);--> statement-breakpoint
ALTER TABLE `stock_movements` ADD `entity_id` text NOT NULL REFERENCES entities(id);--> statement-breakpoint
...
--> statement-breakpoint
UPDATE inventory_items SET entity_id = 'default' WHERE entity_id IS NULL;
--> statement-breakpoint
UPDATE invoices SET entity_id = 'default' WHERE entity_id IS NULL;
--> statement-breakpoint
UPDATE stock_movements SET entity_id = 'default' WHERE entity_id IS NULL;