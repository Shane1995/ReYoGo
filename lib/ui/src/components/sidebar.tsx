...
const SidebarNav = React.forwardRef<HTMLUListElement, React.HTMLAttributes<HTMLUListElement>>(
  ({ className, ...props }, ref) => (
    <ul
      ref={ref}
      data-sidebar="nav"
...
export interface SidebarNavLinkProps extends React.ComponentPropsWithoutRef<'a'> {
  active?: boolean;
}
  ...
  ({ className, active, ...props }, ref) => (
    <a
      ...
      className={cn(
        ...
        active &&
          'border-l-[var(--sidebar-primary)] bg-[var(--sidebar-accent)] text-[var(--sidebar-accent-foreground)]',
        className,
      )}
      data-active={active}
      {...props}
