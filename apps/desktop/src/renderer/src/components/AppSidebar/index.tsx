    ...
    >
      ...
      >
        ...
        <AnimatePresence initial={false}>
          {!collapsed && (
            <motion.div key="brand" {...labelAnim} className="flex flex-col gap-0.5 overflow-hidden">
              <span className="whitespace-nowrap text-sm font-semibold leading-none text-white">ReYoGo</span>
              <span className="whitespace-nowrap text-xs text-[rgba(255,255,255,0.3)]">Pub &amp; Restaurant</span>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
