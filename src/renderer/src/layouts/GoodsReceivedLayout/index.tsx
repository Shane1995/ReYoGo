...
const subNavItems = [
  { label: "Overview",       path: ProductRoutes.GoodsReceived,                      icon: LayoutDashboardIcon, end: true  },
  { label: "Analysis",       path: AnalysisRoutes.CostPerUnit,                        icon: TrendingUpIcon,      end: false },
  { label: "Captured Goods", path: GoodsReceivedCaptureRoutes.CapturedGoodsReceived,  icon: PackagePlusIcon,     end: false },
