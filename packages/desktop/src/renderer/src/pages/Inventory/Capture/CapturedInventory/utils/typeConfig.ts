...
export const FALLBACK_PALETTE: TypeConfig[] = [
  {
    ...
    badgeClass:
      'border-transparent bg-violet-100 text-violet-800 dark:bg-violet-900/60 dark:text-violet-300',
    treeLine: 'border-violet-200 dark:border-violet-800',
    icon: PackageIcon,
  },
  {
    color: 'text-rose-700 dark:text-rose-400',
    badgeClass:
      'border-transparent bg-rose-100 text-rose-800 dark:bg-rose-900/60 dark:text-rose-300',
    treeLine: 'border-rose-200 dark:border-rose-800',
    icon: PackageIcon,
  },
  {
    color: 'text-teal-700 dark:text-teal-400',
    badgeClass:
      'border-transparent bg-teal-100 text-teal-800 dark:bg-teal-900/60 dark:text-teal-300',
    treeLine: 'border-teal-200 dark:border-teal-800',
    icon: PackageIcon,
  },
  {
    color: 'text-orange-700 dark:text-orange-400',
    badgeClass:
      'border-transparent bg-orange-100 text-orange-800 dark:bg-orange-900/60 dark:text-orange-300',
    treeLine: 'border-orange-200 dark:border-orange-800',
    icon: PackageIcon,
  },
];
